 ...
 */
final class Version20220221234229 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE abonnement CHANGE offres_id offres_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE abonnement CHANGE offres_id offres_id INT NOT NULL');
