...
class UserController extends BaseController
{
    ...
    /**
     * @Route("/admin/user/compte/{id}",name="compte")
     * @IsGranted("ROLE_USER")
     */
    public function editcompte(User $user, Request $request, TranslatorInterface $translator)
    {
        $form = $this->createForm(compteForm::class, $user, ["translator" => $translator]);
        $form->get('justpassword')->setData($user->getPassword());
        $therole = $this->roleRepository->findOneBy(["roleName" => $user->getRoles()[0]]);
        ...
        return $this->render("admin/user/compte.html.twig", ["compteForm" => $form->createView()]);
    }
    ...
    /**
     * @Route("/admin/user/show", name="user_show",methods={"GET"})
     */
